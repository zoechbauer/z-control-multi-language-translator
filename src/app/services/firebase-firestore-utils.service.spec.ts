...
describe('FirebaseFirestoreUtilsService', () => {
  ...
  describe('getDisplayedUserStatistics', () => {
    ...
    describe('single-month behavior parity', () => {
      ...
      const TEST_NAME =
        'should sort displayedUserStatistics by translation date descending or creation date descending ' +
      ...
      it(TEST_NAME, async () => {
        ...
        expect(actualOrder).toEqual(
          expectedOrder,
          'Users should be sorted by last translation date desc, ' +
          'or creation date desc if translation date is not available'
        );
      });
  ...
  describe('getUserStatisticsSummary', () => {
    ...
    function addStatisticsData(
      ...
      statisticsData.push({
        ...
        targetLanguages,
        lastTranslationDate:
          translatedCharCount > 0 ? lastTranslationDate : null,
      });
    }
