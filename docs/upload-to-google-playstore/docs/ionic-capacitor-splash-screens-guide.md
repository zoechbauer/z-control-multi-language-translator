...
```scss
body {
  background-color: #3b82f6 !important; /* Blue for Translator app */
}

@media (prefers-color-scheme: dark) {
  body {
    background-color: #1e293b !important; /* Dark blue for Translator app */
  }
}
```
...
- **Light mode**: Custom blue splash screen → Brief blue background → App content
- **Dark mode**: Custom dark blue splash screen → Brief dark background → App content
